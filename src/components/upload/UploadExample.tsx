			...
			<div className="max-w-7xl mx-auto">
				...
				<div className="text-center mb-12">
					...
					<p className="text-lg text-gray-600 max-w-2xl mx-auto">
						...
						Features include intelligent processing, real-time progress tracking, and comprehensive insights.
					</p>
				</div>
				...
				<div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-8">
					<div className="bg-white rounded-xl p-6 shadow-lg">
						...
						<h3 className="text-xl font-semibold text-gray-900 mb-2">Intelligent Processing</h3>
						<p className="text-gray-600">
							Advanced AI pipeline automatically detects objects, categories, and provides comprehensive analysis.
						</p>
					</div>
					...
					<div className="bg-white rounded-xl p-6 shadow-lg">
						...
						<p className="text-gray-600">
							Real-time progress tracking and status updates keep users informed throughout the analysis process.
						</p>
					</div>
					...
					<div className="bg-white rounded-xl p-6 shadow-lg">
						...
						<h3 className="text-xl font-semibold text-gray-900 mb-2">Comprehensive Insights</h3>
						<p className="text-gray-600">
							Get detailed insights including news, web results, YouTube videos, and nutritional information.
						</p>
					</div>
				</div>
				...
				<div className="mt-16 bg-white rounded-2xl shadow-xl p-8">
					...
					<div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
						<div>
							<h3 className="text-lg font-semibold text-gray-900 mb-4">Enhanced Architecture</h3>
						...
						<div>
							<h3 className="text-lg font-semibold text-gray-900 mb-4">AI Analysis Pipeline</h3>
							<ul className="space-y-2 text-gray-600">
